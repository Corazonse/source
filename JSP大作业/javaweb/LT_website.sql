...
CREATE TABLE `forum` (
  ...
  `fm_condition` int(11) NOT NULL COMMENT '帖子状态',
...
insert  into `forum`(`fm_id`,`fm_topic`,`fm_condition`,`fm_address`,`fm_top`,`fm_body`,`user_posts`) values (1,'first',1,'',0,'hello',''),(2,'second',1,'',0,'hi',''),(3,'third',1,'',0,'heiheihei',''),(4,'fourth',0,'',0,'love',''),(5,'fifth',0,'',0,'nihao',''),(6,'sixth',0,'',0,'wdnmd','');
...
insert  into `users`(`user_name`,`user_id`,`user_passwd`,`user_posts`,`user_account`) values ('firstUser',1,'12341','','412123'),('sb',2,'abc','','Iamasb'),('wdnmd',3,'1234','','12345');
