...
public class ForumTable implements ForumDao {
    ...
    public ArrayList<Forum> selForum() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                item.setCondition(resultSet.getInt("fm_condition"));
    ...
    public int setForm(Forum forum) {
        ...
        try {
            ...
            statement.setInt(2, forum.getCondition());
    ...
    public int addForm(Forum forum) {
        ...
        try {
            ...
            statement.setInt(3, forum.getCondition());
    ...
    @Override
    public int delForm(Forum forum) {
        String sql="delete from forum WHERE fm_id = ?";
        Connection connection = DbHelper.getConnection();
        try {
            PreparedStatement statement = connection.prepareStatement(sql);
            // 设置参数
